...
public class AnimalESP extends Module{
	public AnimalESP()
	{
		super("AnimalESP", 0, Category.RENDER, true);
	}
	...
	public void onRender() {
		for(Object o : getMinecraft().theWorld.loadedEntityList) {
			if(o instanceof EntityAnimal) {
				EntityAnimal ep = (EntityAnimal) o;
	...
	public void drawESP(double d, double d1, double d2, EntityAnimal ep, double e, double f)
	{
	        GL11.glPushMatrix();
	        GL11.glEnable(3042);
	...
	public void drawESP2(double d, double d1, double d2, EntitySquid ep, double e, double f)
	{
	        GL11.glPushMatrix();
	        GL11.glEnable(3042);
	        GL11.glColor4f(0.27F, 0.70F, 0.92F, 0.15F);
