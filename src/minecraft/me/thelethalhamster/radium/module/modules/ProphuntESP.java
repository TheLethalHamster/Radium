...
public class ProphuntESP extends Module{
	...
	public ProphuntESP() {
		super("PropHuntESP", 0, Category.RENDER, true);
	}
	...
	public void onRender() {
		for(Object o : getWorld().loadedEntityList) {
			if(o instanceof EntityFallingBlock) {
				EntityFallingBlock ep = (EntityFallingBlock) o;
				...
				drawESP(d - 0.5d - RenderManager.renderPosX, d1 - 0.5d - RenderManager.renderPosY, d2 - 0.5d - RenderManager.renderPosZ, 1.0F, 0.0F, 1.0F);
			}
		}
	}
