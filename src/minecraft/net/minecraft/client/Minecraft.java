...
public class Minecraft implements IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Radium v1 (rel-1.7.x)");
    ...
    {
    	p_147108_1_ = HookManager.getInstance().onGuiScreen(p_147108_1_);
        ...
        {
        	HookManager.getInstance().onPlayerDeath();
    ...
    public void runTick()
    {
    	HookManager.getInstance().onGameTick();
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        {
                        	HookManager.getInstance().KeyBind(Keyboard.getEventKey());
    ...
    private void func_147112_ai()
    {
        if (this.objectMouseOver != null)
        {
        	HookManager.getInstance().onMiddleClick();
    ...
    public void setSession(Session authResponse) {
