...
public class EntityClientPlayerMP extends EntityPlayerSP
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.blockExists(MathHelper.floor_double(this.posX), 0, MathHelper.floor_double(this.posZ)))
        {
        	...
        	HookManager.getInstance().preMotionUpdate();
        	
            super.onUpdate();
            
            HookManager.getInstance().onMotionUpdate();
            ...
            HookManager.getInstance().postMotionUpdate();
        }
    }
    ...
    {
        if(HookManager.getInstance().onSendChatMessage(par1Str)){
    ...
    {
    	HookManager.getInstance().onPlayerRespawn();
