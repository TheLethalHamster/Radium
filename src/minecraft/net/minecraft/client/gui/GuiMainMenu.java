...
import me.thelethalhamster.radium.altmanager.AltAccountSwitch;
import me.thelethalhamster.radium.override.GuiRadiumButton;
import me.thelethalhamster.radium.screens.GuiRadium;
...
public class GuiMainMenu extends GuiScreen
{
    ...
    private static final ResourceLocation background = new ResourceLocation("textures/gui/title/bg.png");
    ...
    public void initGui()
    {
        ...
        this.func_130020_g();
        this.buttonList.add(new GuiRadiumButton(0, this.width / 2 - 100, var3 + 72 + 24, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiRadiumButton(4, this.width / 2 + 2, var3 + 72 + 24, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    {
        this.buttonList.add(new GuiRadiumButton(1, this.width / 2 - 100, par1, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiRadiumButton(2, this.width / 2 - 100, par1 + par2 * 1, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(new GuiRadiumButton(100, this.width / 2 - 100, par1 + 48, I18n.format("Account Manager", new Object[0])));
        this.buttonList.add(new GuiRadiumButton(200, this.width / 2 - 100, par1 + par2 * 1 + 25 + 23, I18n.format("Radium Options", new Object[0])));
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
    	...
    	{
    		this.mc.displayGuiScreen(new GuiRadium(this));
    	}
    	
    	if (p_146284_1_.id == 100) 
    	{
    		this.mc.displayGuiScreen(new AltAccountSwitch(this));
    	}
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Radium v1 (rel-1.7.x)";
        ...
        String var10 = "Coded By TheLethalHamster";
