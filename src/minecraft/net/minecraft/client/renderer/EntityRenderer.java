...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            HookManager.getInstance().onRender();
    ...
    public void updateCameraAndRenderBackwards(float par1)
    {
        this.mc.mcProfiler.startSection("lightTex");
        ...
        {
            this.mc.mouseHelper.mouseXYChange();
            float var18 = this.mc.gameSettings.mouseSensitivity * 0.6F + 0.2F;
            float var4 = var18 * var18 * var18 * 8.0F;
            float var5 = (float)this.mc.mouseHelper.deltaX * var4;
            float var6 = (float)this.mc.mouseHelper.deltaY * var4;
            byte var7 = 1;
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                {
                    this.renderWorldBackwards(par1, 0L);
                }
                else
                {
                    this.renderWorldBackwards(par1, this.renderEndNanoTime + (long)(1000000000 / var181));
                }
    ...
    public void renderWorldBackwards(float par1, long par2)
    {
        this.mc.mcProfiler.startSection("lightTex");
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            this.mc.mcProfiler.endStartSection("clear");
            GL11.glViewport(0, 0, 200 * 2, 200 * 2);
            this.updateFogColor(par1);
            GL11.glEnable(GL11.GL_CULL_FACE);
            this.mc.mcProfiler.endStartSection("camera");
            this.setupCameraTransformBackwards(par1, var13);
            ActiveRenderInfo.updateRenderInfo(this.mc.thePlayer, this.mc.gameSettings.thirdPersonView == 2);
            this.mc.mcProfiler.endStartSection("frustrum");
            ClippingHelperImpl.getInstance();
    ...
    private void setupCameraTransformBackwards(float par1, int par2)
    {
        this.farPlaneDistance = (float)(256 >> this.mc.gameSettings.renderDistanceChunks);
        GL11.glMatrixMode(GL11.GL_PROJECTION);
        GL11.glLoadIdentity();
        float var3 = 0.07F;
        ...
        Project.gluPerspective(this.getFOVModifier(par1, true), (float)200 / (float)200, 0.05F, this.farPlaneDistance * 2.0F);
        float var4;
        ...
        this.orientCameraBackwards(par1);
    ...
    private void orientCameraBackwards(float par1)
    {
        EntityLivingBase var2 = this.mc.renderViewEntity;
        float var3 = var2.yOffset - 1.62F;
        double var4 = var2.prevPosX + (var2.posX - var2.prevPosX) * (double)par1;
    ...
    public int performanceToFps(int par0)
    {
        short var1 = 200;
